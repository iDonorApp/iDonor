...
const createNewRequest = async (body) => {
  const { rumah_sakit, nama, umur, golongan, no_kamar, no_whatsapp, id_users } = body;
  ...
  const values = [id_request, id_users, rumah_sakit, nama, umur, golongan, no_kamar, no_whatsapp, whatsappUrl];
